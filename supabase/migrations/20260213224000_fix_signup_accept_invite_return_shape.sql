-- Fix signup_and_accept_invite ambiguity by removing output-column name collision
-- with tenant_property_links.property_id.

DROP FUNCTION IF EXISTS public.signup_and_accept_invite(TEXT, TEXT);
...
'Atomic signup+accept invite; enforces one active property link per tenant and returns out_property_id.';
