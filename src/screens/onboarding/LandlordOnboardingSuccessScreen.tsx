...
type SuccessRouteProp = RouteProp<RootStackParamList, 'LandlordOnboardingSuccess'>;

const nextSteps = [
  { icon: '📸', text: 'Add photos to your property' },
  { icon: '📝', text: 'Review and respond to maintenance requests' },
  { icon: '💬', text: 'Chat with your tenants' },
];

export default function LandlordOnboardingSuccessScreen() {
      ...
      <View style={styles.content}>
        ...
        <View style={styles.heroSection}>
          ...
          <Text style={styles.subtitle}>
            Your property is ready. You can now manage everything from your dashboard.
          </Text>
        </View>
